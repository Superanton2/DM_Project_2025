...
def print_start():
    for line in chart_ascii:
        print(line)

    print()
    print(f"{YELLOW}Welcome to the discrete mathematics project{RESET}")
    print(f"     {YELLOW}'Topological sorting on DFS'{RESET}")
    print("by Anton Fedoriv, Andrew Korzh, Kateryna Sadovska")
